...
var cloneGraph = function(node) {
    ...
    // use dfs to traverse through the adjacency list
    const dfs = (currNode) => {
      if (!currNode) {
        return null;
      }
      ...
      if (oldToNew[currNode.val] !== undefined) {
        return oldToNew[currNode.val];
      }

      // if clone doesn't already exist, create clone
      const clone = new Node(currNode.val);
      oldToNew[currNode.val] = clone;
